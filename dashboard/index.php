...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="dash.php" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>&nbsp; Inicio</a>
    <a href="cursos.php" class="w3-bar-item w3-button w3-padding w3-padding"><i class="fa fa-users fa-fw"></i>&nbsp; Servicios</a>
