...
<div class="w3-container" style="padding:128px 16px" id="">
  ...
  <div class="w3-row-padding w3-grayscale" style="margin-top:64px">
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="/w3images/team1.jpg" alt="Ingeniero Juan Manuel Fernandez Alvarez" style="width:100%">
        <div class="w3-container">
          <h3>Metodologia Scrum</h3>
          <p class="w3-opacity">Ingeniero Juan Manuel Fernandez Alvarez </p>
          <p>En este curso aprenderan scrum.</p>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="/w3images/team3.jpg" alt="Ingeniero Juan Manuel Fernandez Alvarez" style="width:100%">
        <div class="w3-container">
          <h3>Metodologia Scrum</h3>
          <p class="w3-opacity">Ingeniero Juan Manuel Fernandez Alvarez </p>
          <p>En este curso aprenderan scrum.</p>
    ...
    <div class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-card">
        <img src="/w3images/team4.jpg" alt="Ingeniero Juan Manuel Fernandez Alvarez" style="width:100%">
        <div class="w3-container">
          <h3>Metodologia Scrum</h3>
...
<div class="w3-container" style="padding:128px 16px" id="work">
  ...
  <div class="w3-row-padding" style="margin-top:64px">
    <div class="w3-col l3 m6">
      <img src="/w3images/tech_mic.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="Desarrollo de habilidad de CEO con este curso impartido por quien tu quieras.">
      <p class="w3-center w3-large">Desarrolla tu habilidad de Ceo</p>
    </div>
    <div class="w3-col l3 m6">
      <img src="/w3images/tech_phone.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="con este curso impartido por quien tu quieras.">
        <p class="w3-center w3-large">Tu contabilidad con facilidad</p>
    </div>
    <div class="w3-col l3 m6">
      <img src="/w3images/tech_drone.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="con este curso impartido por quien tu quieras.">
        <p class="w3-center w3-large">Matematicas Computacional</p>
    </div>
    <div class="w3-col l3 m6">
      <img src="/w3images/tech_sound.jpg" style="width:100%" onclick="onClick(this)" class="w3-hover-opacity" alt="con este curso impartido por quien tu quieras.">
