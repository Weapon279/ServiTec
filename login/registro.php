...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $Fk_TypeUser = 4; 
    $iFechaHoraC = date('Y-m-d H:i:s');
    $iFechaHoraA = date('Y-m-d H:i:s'); 

    $sql = "INSERT INTO user (Fk_TypeUser, vNombre, vApellidoP, vApellidoM, vCorreo, nWhats, nPass, bStatus, iFechaHoraC, iFechaHoraA) VALUES ('$Fk_TypeUser', '$vnombre', '$vapellidoP', '$vapellidoM', '$vcorreo', '$nwhats', '$npass', '$bStatus', '$iFechaHoraC', '$iFechaHoraA')";
    ...
    if ($conn->query($sql) === TRUE) {
        echo "<script>
            window.onload = function() {
                ...
                setTimeout(function() {
                    window.location.href = 'http://localhost/gestion/servitec/gestion/';
                }, 3000);
            }
            </script>";
    } else {
...
<div class="bg-img">
  <form action="" method="POST" class="container">
    ...
    <span class="psw">¿Tienes cuenta? <a href="http://localhost/gestion/servitec/gestion/">Inicia Sesion</a></span>
